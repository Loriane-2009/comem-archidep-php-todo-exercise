...
define('BASE_URL', value: '/comem-archidep-php-todo-exercise/');

// Database connection parameters.
define('DB_USER', 'todolist');
define('DB_PASS', 'V5Aw8@&m9JT64pkC^Y$D');
...
if (isset($_POST['action'])) {
  switch($_POST['action']) {
    ...
    case 'delete':
      ...
      $id = $_POST['id'];
      if(is_numeric($id)) {
        $deleteQuery = 'DELETE FROM todo WHERE id = '.$id; // Ellen
 ...
 */
$selectQuery = 'SELECT * FROM todo ORDER BY created_at DESC'; // Loriane
